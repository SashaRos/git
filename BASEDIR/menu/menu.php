...
*****************************************************************************
* Input variables:
* $e defines which nodes to expand. It is set automatically in all links.
*
* $treefile variable needs to be set in main file to point to tree 
* definition file.
*
* Tree file format:
* Each line contains one item, the line starts with a series of dots(.).
* Each dot is one level deeper. Next comes the item name, link,
* bookmark and link target, seperated by |.
* Set target=+ if linked page has the same menu. The links must use 
* absolute virtual paths unless all pages are in the same directory.
* Example:
...
*****************************************************************************
* Output variables:
* $previous and $next can be used for links to previous and next page.
****************************************************************************/

$width2        = 400;                     // width of menu text in pixels
$class1        = 'menu';                  // style class for menu text
$class2        = 'menuselected';          // style class for selected page
$default_index = 'index.php';             // default name of index file
$imagedir      = '/BASEDIR/menu/';        // directory containing images
$botmenu       = '/BASEDIR/menu/';        // link to page with simple menu for search robots
...
/****************************************************************************
*  This is needed if register_globals = off:
****************************************************************************/
...
if ($e != '') {
   $explevels = explode(',',$e);}
elseif (basename($myself) == $default_index) {
   $e='0'; $explevels[0] = '0';}
...
/*****************************************************
*  Seach for active page and for previous and next
*****************************************************/
